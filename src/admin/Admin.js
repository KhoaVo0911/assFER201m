      ...
      <div className="container-fluid">
        <div className="row">
          ...
          <div className="custom-block bg-white">
            <h3 className="mb-4" style={{ textAlign: 'center' }}>Event List</h3>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                      ...
                      <CardContent>
                        <Typography gutterBottom variant="h4" className='text-center' >
                          {item.name.length > 30 ? item.name.slice(0, 15) + '...' : item.name}
                        </Typography>
                        <Typography >
                          ID:{item.id}
                        </Typography>
                        ...
                        <Typography component="div">
                          Description: {item.description.length > 70 ? item.description.slice(0, 70) + '...' : item.description}
                        </Typography>
                        <Typography >
