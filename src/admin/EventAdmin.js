          ...
          <main className="main-wrapper ms-sm-auto py-4 px-md-4 border-start">
            <div className="row my-4">
              <div className="grid grid-cols-2 gap-5">
                <div className="mb-10" style={{ height: 100, width: 450, marginLeft: "200px" }}>
                  <Slider
                  ...
                  {eventCotent && (
                    <div className="bg-white px-4 py-1 mx-36">
                      ...
                      <Typography variant="h6">
                        ...
                        {eventCotent.description.length > 50
                          ? eventCotent.description.slice(0, 50) + "..."
                          : eventCotent.description}
                      </Typography>
                      <Typography variant="h6">
                        <strong>Begin Date:</strong>{" "}
                        {parseTimestamp(eventCotent.beginDate)}
                      </Typography>
                      <Typography variant="h6">
                        <strong>End Date:</strong>{" "}
                        {parseTimestamp(eventCotent.endDate)}
                      </Typography>
                      <Typography variant="h6" className="flex gap-[2px]">
                        <strong>Status:</strong>{" "}
                        {eventCotent.status == true ? (
